public class ControllerUndo {
    private CommandUndo openTVCommand;
    private CommandUndo closeTVCommand;
    private CommandUndo changeChannelCommand;

    public int nowChannel = 0;       //当前频道
    public int priorChannel;     //前一个频道，用于执行返回操作

    public Controller(CommandUndo openTvCommand,CommandUndo closeTvCommand,CommandUndo changeChannelCommand){
